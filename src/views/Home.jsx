...
export default function Home() {
  ...
  return (
    <>
      <div onClick={()=>navigate('/shoes')} className='bg-contain bg-repeat md:bg-[length:500px_200px] min-h-screen bg-gray-100 flex flex-col justify-center px-6 lg:px-8 m-2 rounded dark:bg-slate-600 dark:m-2 dark:rounded' style={{ backgroundImage: `url(${imageBackground})` }}>
